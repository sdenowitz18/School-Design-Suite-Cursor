...
interface SheetContentProps
  ...
  /** When true the overlay won't block pointer events on the rest of the page. */
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, children, overlayPointerEventsNone, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay className={overlayPointerEventsNone ? "pointer-events-none" : undefined} />
